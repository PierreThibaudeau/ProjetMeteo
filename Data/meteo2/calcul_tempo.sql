...
--
-- Structure de la table `calcul_tempo`
--

CREATE TABLE `calcul_tempo` (
  `id` int(11) NOT NULL,
...
--
-- Index pour la table `calcul_tempo`
--
ALTER TABLE `calcul_tempo`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT pour la table `calcul_tempo`
--
ALTER TABLE `calcul_tempo`
